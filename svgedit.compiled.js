...
$.SvgCanvas = function(a, I) {
    ...
    this.setRotationAngle = function(b, f) {
        ...
        } else j.numberOfItems == 0 && d.removeAttribute("transform");
        if (!f) {
                    ...
                    case "text":
                        ...
                        L({
                            ...
                            attr: {
                                ...
                                "letter-spacing": Sa.letter_spacing,
                                "text-anchor": "middle",
                                "xml:space": "preserve",
                                opacity: t.opacity
                            }
                            ...
                            if (m[0] != null) {
                                if (m[1] == null) {
                                    ...
                                    if (N.tagName == "text") {
                                        ...
                                        Sa.letter_spacing = N.getAttribute("letter-spacing")
                                    }
                        ...
                        if (C != "")
                            if (C.indexOf("pointer-events") !== 0)
                                if (!(z.localName === "class" && C.indexOf("se_") === 0)) {
                                    ...
                                    } else C = svgedit.units.shortFloat(C);
    ...
    this.save =
        ...
        //  with new save handler
// this.save = function(b) {
// // remove the selected outline before serializing
//       this.clearSelection();
// // no need for doctype, see http://jwatt.org/svg/authoring/#doctype-declaration
//       var str = svgCanvasToString(); str = "<?xml version='1.0'?>\n" + str; $.post("svg-editor-save.php", { svg_data: escape(str) } );
// };
    ...
    this.getUnderline = function() {
        var b = m[0];
        if (b != null && b.tagName == "text" && m[1] == null) return b.getAttribute("text-decoration") == "underline";
        return false
    };
    this.setUnderline = function(b) {
        var f = m[0];
        if (f != null && f.tagName == "text" && m[1] == null) Va("text-decoration", b ? "underline" : "normal");
        m[0].textContent || La.setCursor()
    };
    ...
    this.getLetterSpacing = function() {
        return Sa.letter_spacing
    };
    this.setLetterSpacing = function(b) {
        Sa.letter_spacing = b;
        Va("letter-spacing", b);
        m[0].textContent || La.setCursor()
    };
                    ...
                    if ((b === "x" || b === "y") && E.indexOf(z.tagName) >= 0) {
                        ...
                        if (B !== String(f)) {
                            ...
                            if (svgedit.browser.isGecko() && z.nodeName === "text" && /rotate/.test(z.getAttribute("transform")))
                                if (String(f).indexOf("url") === 0 || ["font-size", "letter-spacing", "font-family", "x", "y"].indexOf(b) >= 0 && z.textContent) z = Hb(z);
        ...
        window.svgEditor = function(a) {
            ...
            var c, i, s = svgedit.utilities,
                ...
                w = {
                    ...
                    bkgd_url: "",
                    img_save: "embed",
                    save_notice_done: true,
                    export_notice_done: true
                },
                D = {},
                u = {
                    extensions: [],
                ...
                A = ["ext-overview_window.js",
                    "ext-markers.js", "ext-connector.js", "ext-eyedropper.js", "ext-shapes.js", "ext-imagelib.js", "ext-grid.js", "ext-polygon.js", "ext-star.js", "ext-panning.js", "ext-storage.js", "ext-fliptools.js","ext-artlib.js"
                ],
                p = {
                    canvasName: "default",
                    canvas_expansion: 3,
            ...
            o.init = function() {
                        ...
                        if (h != null) {
                            ...
                            if (F[na]) {
                                ...
                                if (na == "text") {
                                    ...
                                    c.getUnderline() ? a("#tool_underline").addClass("push_button_pressed").removeClass("tool_button") : a("#tool_underline").removeClass("push_button_pressed").addClass("tool_button");
                                    a("#font_family").val(h.getAttribute("font-family"));
                                    a("#font_size").val(h.getAttribute("font-size"));
                                    a("#letter_spacing").val(h.getAttribute("letter-spacing"));
                ...
                var Ga = {},
                    ...
                    Yb = o.setIconSize = function(h) {
                        var k = a("#tools_top .toolset, #editor_panel > *, #history_panel > *,\t\t\t\t#main_button, #tools_left > *, #path_node_panel > *, #multiselected_panel > *,\t\t\t\t#g_panel > *, #tool_font_size > *, #tool_letter_spacing > *, .tools_flyout"),
                            H = 1;
                        H = typeof h === "number" ? h : {
                            s: 0.75,
                            m: 1,
                        ...
                        k = a("#tool_size_rules");
                        if (k.length) k.empty();
                        else k = a('<style id="tool_size_rules"></style>').appendTo("head");
                        if (h !== "m") {
                            var Q = "";
                            ...
                            F = "-" + Qb.toLowerCase() + "-";
                            Q += "#tools_top .toolset, #editor_panel > *, #history_panel > *,\t\t\t\t#main_button, #tools_left > *, #path_node_panel > *, #multiselected_panel > *,\t\t\t\t#g_panel > *, #tool_font_size > *, #tool_letter_spacing > *, .tools_flyout{" + F + "transform: scale(" + H + ");} #svg_editor div.toolset .toolset {" + F + "transform: scale(1); margin: 1px !important;} #svg_editor .ui-slider {" +
                ...
                a("#palette").append(Za);
                Za = "";
                a.each(["#FFF", "#888", "#000", "#a3bdc8", "#93898e", "#bc727a", "#f2d1cc"], function() {
                ...
                var wb = function(h, k) {
                        ...
                        if (!h ||
                            !h.handle) a("#opac_slider").slider("option", "value", k);
                        c.setOpacity(k / 100)
                    },
                    Tb = function(h, k, H) {
                        if (k == null) k = h.value;
                ...
                var wc = function() {
                    ...
                    zc = o.savePreferences = function() {
						...
						var filename = $("#canvas_bg_url1").val();
                        var img = document.getElementById("#canvas_bg_url1");
                            
                        var filen = filename.substring(filename.lastIndexOf('h') + 1);
                        var path='http://192.169.197.129/dev/premiumprint/print/uploads'+'/'+filen;

                        $("#canvas_bg_url").attr("value",path);
    ...
    I.readLang = function(i) {
        ...
        if (i.tools) {
            ...
            o("title", {
                ...
                tool_letter_spacing: s.letter_spacing,
